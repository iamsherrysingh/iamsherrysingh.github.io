    ...
    if(gamePlaying){
        ...
        if(dice !== 1){
            ...
            if(info === 'You have to roll dice before you can hold'){
                ...
                document.querySelector('.info').textContent = 'PLAYER '+ activePlayerRealNumber + ' turn';
            }
        }else{
            nextPlayer();
        }
...
document.querySelector('.btn-hold').addEventListener('click', function(){
    if(gamePlaying && roundScore === 0){
        document.querySelector('.info').textContent='You have to roll dice before you can hold';
    }
    ...
    if(gamePlaying && roundScore !== 0){
        ...
        if(score[activePlayer] >=100){
            ...
            var activePlayerRealNumber= activePlayer+1;
            document.querySelector('.info').textContent='PLAYER ' + activePlayerRealNumber + ' Wins!';
            document.querySelector('.dice').style.display = 'none';
